    ...
    return Stack(
      ...
      children: [
        ...
        Positioned(
          ...
          top: top + 20, // Center vertically with respect to profile image
            ...
            builder: (context, snapshot) {
              ...
              return Column(
                children: [
                  ...
                  Text('$followersCount', style: TextStyle(color: Colors.white, fontSize: 16)),
                ],
              );
            },
          ),
            ...
            builder: (context, snapshot) {
              ...
              return Column(
                children: [
                  ...
                  Text('$followingCount', style: TextStyle(color: Colors.white, fontSize: 16)),
                ],
              );
            },
          ),
